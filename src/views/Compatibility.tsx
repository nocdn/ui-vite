    ...
    <>
      ...
      <div className="max-w-4xl">
        ...
        <p className="mt-6 font-inter text-gray-700 leading-7">
          ...
          <span className="code-inline">@ → src</span> alias for the bundler.
        </p>
        ...
        <p className="mt-6 font-inter text-gray-700 leading-7">
          ...
          needed, disable initial animations on first paint or gate with
          hydration checks.
        </p>
        <p className="font-jetbrains-mono font-semibold text-[12px] leading-6 tracking-widest text-gray-600 mt-6">
          TROUBLESHOOTING
        ...
        <p className="mt-6 font-inter text-gray-700 leading-7">
          <p>
            <span className="code-inline">Module not found '@/lib/utils'</span>{" "}
            → check your bundler alias config and that cn util is resolvable.
          </p>
          <p>
            <span className="code-inline">Types not found</span> → ensure
