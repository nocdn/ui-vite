export default function IntroductionView() {
  return (
    <>
      <title>Introduction to nocdn/ui</title>
      <div className="max-w-4xl">
        ...
        <p className="mt-6 font-inter text-gray-700 leading-7">
          ...
          projects, so adding them to a shadcn registry is also quite helpful
          for me.
        </p>
        <p className="mt-6 font-inter text-gray-700 leading-7">
          Feel free to look around, use them in your own projects, and
          contribute to the library if you'd like. You can find a list of the
          components in the sidebar, but if you are not familiar with UI
          libraries, I recommend reading the{" "}
